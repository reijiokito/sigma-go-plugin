...
// sigma.Request.GetScheme() returns the scheme component of the request’s URL.
// The returned value is normalized to lower-case form.
func (r Request) GetScheme() (s string, err error) {
	return r.AskString(`sigma.request.get_scheme`)
}

// sigma.Request.GetHost() returns the host component of the request’s URL,
// or the value of the “Host” header. The returned value is normalized
// to lower-case form.
func (r Request) GetHost() (host string, err error) {
	return r.AskString(`sigma.request.get_host`)
}

// sigma.Request.GetPort() returns the port component of the request’s URL.
func (r Request) GetPort() (int, error) {
	return r.AskInt(`sigma.request.get_port`)
}

// sigma.Request.GetForwardedScheme() returns the scheme component
...
// on several sigma configuration parameters:
//
//   - trusted_ips
//   - real_ip_header
//   - real_ip_recursive
...
func (r Request) GetForwardedScheme() (s string, err error) {
	return r.AskString(`sigma.request.get_forwarded_scheme`)
}

// sigma.Request.GetForwardedHost() returns the host component of the request’s URL
// or the value of the “host” header. Unlike sigma.Request.GetHost(), this function
...
func (r Request) GetForwardedHost() (host string, err error) {
	return r.AskString(`sigma.request.get_forwarded_host`)
}

// sigma.Request.GetForwardedPort() returns the port component of the request’s URL,
...
func (r Request) GetForwardedPort() (int, error) {
	return r.AskInt(`sigma.request.get_forwarded_port`)
}

// sigma.Request.GetHttpVersion() returns the HTTP version
...
func (r Request) GetHttpVersion() (version float64, err error) {
	return r.AskFloat(`sigma.request.get_http_version`)
}

// sigma.Request.GetMethod() returns the HTTP method of the request.
// The value is normalized to upper-case.
func (r Request) GetMethod() (m string, err error) {
	return r.AskString(`sigma.request.get_method`)
}

// sigma.Request.GetPath() returns the path component of the request’s URL.
// It is not normalized in any way and does not include the querystring.
func (r Request) GetPath() (string, error) {
	return r.AskString(`sigma.request.get_path`)
}

// sigma.Request.GetPathWithQuery() returns the path, including
// the querystring if any. No transformations/normalizations are done.
func (r Request) GetPathWithQuery() (string, error) {
	return r.AskString(`sigma.request.get_path_with_query`)
}

// sigma.Request.GetRawQuery() returns the query component of the request’s URL.
...
func (r Request) GetRawQuery() (string, error) {
	return r.AskString(`sigma.request.get_raw_query`)
}

// sigma.Request.GetQueryArg() returns the value of the specified argument,
...
func (r Request) GetQueryArg(k string) (string, error) {
	return r.AskString(`sigma.request.get_query_arg`, k)
}

// sigma.Request.GetQuery() returns a map of query arguments
...
func (r Request) GetQuery(max_args int) (map[string][]string, error) {
	if max_args == -1 {
		return r.AskMap("sigma.request.get_query")
	}

	return r.AskMap("sigma.request.get_query", max_args)
}

// sigma.Request.GetHeader() returns the value of the specified request header.
//
...
func (r Request) GetHeader(k string) (string, error) {
	return r.AskString(`sigma.request.get_header`, k)
}

// sigma.Request.GetHeaders() returns a map holding the request headers.
...
func (r Request) GetHeaders(max_headers int) (map[string][]string, error) {
	if max_headers == -1 {
		return r.AskMap(`sigma.request.get_headers`)
	}

	return r.AskMap(`sigma.request.get_headers`, max_headers)
}

// sigma.Request.GetRawBody() returns the plain request body.
//
...
func (r Request) GetRawBody() (string, error) {
	return r.AskString(`sigma.request.get_raw_body`)
}
